...
HD_PWD='C:/Users/ThibaultPB/Desktop/VHDL V2/Implementation-hardware-du-PSO/velocity_memory/velocity_memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VM.tcl
