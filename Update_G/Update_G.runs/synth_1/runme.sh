...
HD_PWD='C:/Users/IDEAL-INFO/Desktop/VHDL V2/Implementation-hardware-du-PSO/Update_G/Update_G.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log g_best.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source g_best.tcl
