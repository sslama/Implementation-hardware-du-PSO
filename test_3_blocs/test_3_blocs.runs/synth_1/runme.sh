...
HD_PWD='C:/Users/IDEAL-INFO/Desktop/VHDL V2/Implementation-hardware-du-PSO/test_3_blocs/test_3_blocs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_3.tcl
