...
HD_PWD='C:/Users/ThibaultPB/Desktop/VHDL V2/Implementation-hardware-du-PSO/Position_memory/Position_memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PM.tcl
