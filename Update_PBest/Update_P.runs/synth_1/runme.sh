...
HD_PWD='C:/Users/IDEAL-INFO/Desktop/VHDL V2/Implementation-hardware-du-PSO/Update_PBest/Update_P.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p_best.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p_best.tcl
