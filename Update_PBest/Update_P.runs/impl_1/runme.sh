...
HD_PWD='C:/Users/IDEAL-INFO/Desktop/VHDL V2/Implementation-hardware-du-PSO/Update_PBest/Update_P.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p_best.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p_best.tcl -notrace
