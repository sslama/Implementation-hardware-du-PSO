...
HD_PWD='C:/Users/ThibaultPB/Desktop/VHDL V2/Implementation-hardware-du-PSO/Update_Position/Update_Position.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log position.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source position.tcl
