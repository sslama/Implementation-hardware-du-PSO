...
HD_PWD='C:/Users/ThibaultPB/Desktop/VHDL V2/Implementation-hardware-du-PSO/Pbest_memory/Pbest_memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PBM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PBM.tcl
