...
HD_PWD='C:/Users/IDEAL-INFO/Desktop/VHDL V2/Implementation-hardware-du-PSO/final_code/final_code.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_code.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source final_code.tcl
